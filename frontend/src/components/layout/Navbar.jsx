    ...
    <header className="fixed top-0 w-full z-50 glass-nav shadow-ambient">
      <nav className="flex items-center justify-between px-6 h-16 w-full max-w-none">
        <div className="flex items-center gap-4">
          ...
          <span className="text-xl font-extrabold text-primary tracking-tighter font-headline">CSE Build Lab</span>
        </div>
        <div className="hidden md:flex items-center gap-10 absolute left-1/2 transform -translate-x-1/2 whitespace-nowrap">
          ...
          <Link className={linkClass("/testimonials")} to="/testimonials">Testimonials</Link>
