  ...
  return (
    <div className="bg-surface font-body text-on-surface antialiased min-h-screen">
      ...
      <main className="pt-24 pb-32 px-6 max-w-4xl mx-auto">
        <section className="bg-surface-container-lowest rounded-3xl p-8 md:p-16 shadow-ambient border border-outline-variant/10 relative overflow-hidden">
            ...
            <div className="space-y-8 text-lg text-on-surface-variant leading-relaxed relative z-10 font-medium">
                ...
                <p className="p-6 bg-primary-container/30 border-l-4 border-primary rounded-r-2xl italic text-on-surface shadow-ambient">
                ...
                <p className="text-xl font-bold text-primary mt-12 bg-surface-container border border-primary/20 p-8 rounded-2xl text-center shadow-ambient font-headline">
